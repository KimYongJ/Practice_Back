...
public class CartController {
    ...
    public ResponseEntity<Object> countCartItems(){return cartService.countCartItems();}
    /**
     * 카트에 새로운 상품 추가하기
     *
     * @return ResponseEntity<Object>
    ...
    public ResponseEntity<Object> insertCartItem(@Valid @RequestBody CartRequestDTO cartRequestDTO) {// @RequestBody 어노테이션은 요청 본문의 데이터를 자바 객체로 자동 변환함
        return cartService.insertCartItem(cartRequestDTO.getQuantity(), cartRequestDTO.getItemId());
    }
    /**
    ...
    public ResponseEntity<Object> patchCartItem(@Valid @RequestBody CartRequestDTO cartRequestDTO){
        return cartService.updateCartItem(cartRequestDTO.getQuantity(), cartRequestDTO.getItemId());
    }
    ...
    public ResponseEntity<Object> deleteCartItem(@RequestBody CartRequestDTO cartRequestDTO){
        return cartService.deleteCartItem(cartRequestDTO.getItemId());
    }
